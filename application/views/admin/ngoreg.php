              ...
              <div class="card-panel">
                ...
                <div class="row">
                   <?php echo form_open_multipart('NgoRegCtrl/ngoreg_insert_update/' . $id); ?>
					...
					<div class="row">
                      <div class="input-field col s3">
					  <input name="kycdoc" type="radio" value="upload_doc" id="upload_doc" <?php if ($ngo_insert_update['kycdoc'] == "upload_doc") {
...
?>/>
					  ...
					  <div class="input-field col s3">
					  <input name="kycdoc" type="radio" id="physical_collect" value="physical_collect" <?php if ($ngo_insert_update['kycdoc'] == "physical_collect") {
    echo 'checked="checked"';
}
?>/>
					  ...
					  <div class="input-field col s3">
					  <input name="kycdoc" type="radio" id="mail_serv" value="mail_serv" <?php if ($ngo_insert_update['kycdoc'] == "mail_serv") {
    echo 'checked="checked"';
}
?>/>
                    ...
                    <select name="status">
                      ...
                      <option value="Active"<?php if ($ngo_insert_update['status'] == "Active") {
    echo 'selected="selected"';
}
?>>Approved</option>
					  <option value="Inactive"<?php if ($ngo_insert_update['status'] == "Inactive") {
    echo 'selected="selected"';
}
?>>Inactive</option>
                      <option value="Pending"<?php if ($ngo_insert_update['status'] == "Pending") {
    echo 'selected="selected"';
}
?>>Pending</option>
                      <option value="Hold"<?php if ($ngo_insert_update['status'] == "Hold") {
    echo 'selected="selected"';
}
?>>Hold</option>
                    </select>
